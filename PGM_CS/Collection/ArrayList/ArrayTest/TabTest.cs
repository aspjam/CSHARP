...
namespace System.Collections
{
    ...
    public class ArrayList : IList, ICloneable
    {
        ...
        public virtual int IndexOf(Object value, int startIndex, int count)
        {
            if (startIndex > _size)
                throw new ArgumentOutOfRangeException("startIndex", ("ArgumentOutOfRange_Index"));
            if (count < 0 || startIndex > _size - count) throw new ArgumentOutOfRangeException("count", ("ArgumentOutOfRange_Count"));
        ...
        private class IListWrapper : ArrayList
        {
            ...
            public override void CopyTo(int index, Array array, int arrayIndex, int count)
            {
                ...
                if (index < 0 || arrayIndex < 0)
                    throw new ArgumentOutOfRangeException((index < 0) ? "index" : "arrayIndex");
                if (count < 0)
                    throw new ArgumentOutOfRangeException("count");
            ...
            {
                if (startIndex < 0 || startIndex > this.Count) throw new ArgumentOutOfRangeException("startIndex", ("ArgumentOutOfRange_Index"));
                if (count < 0 || startIndex > this.Count - count) throw new ArgumentOutOfRangeException("count", ("ArgumentOutOfRange_Count"));
            ...
            public override void InsertRange(int index, ICollection c)
            {
                if (c == null)
                    throw new ArgumentNullException("c", ("ArgumentNull_Collection"));
                if (index < 0 || index > this.Count) throw new ArgumentOutOfRangeException("index", ("ArgumentOutOfRange_Index"));
